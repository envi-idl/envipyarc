"""
Maps the ENVITENSORFLOWOBJECTMODEL data type to a GPTool datatype
"""
...
class ENVITENSORFLOWOBJECTMODEL(ParamTemplate):
    """
    ...
    def pre_execute(self):
        ...
        if not path is None:
            input_params['${name}'] = {'url':path, 'factory':'ENVITENSORFLOWOBJECTMODEL'}
            '''
        )
...
def template():
    ...
    return ENVITENSORFLOWOBJECTMODEL('DEFile')
