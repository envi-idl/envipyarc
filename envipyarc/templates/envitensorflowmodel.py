"""
Maps the ENVITENSORFLOWMODEL data type to a GPTool datatype
"""
...
class ENVITENSORFLOWMODEL(ParamTemplate):
    """
...
''')
    ...
    def pre_execute(self):
        ...
        if not path is None:
            input_params['${name}'] = {'url':path, 'factory':'ENVITENSORFLOWMODEL'}
''')
...
def template():
    ...
    return ENVITENSORFLOWMODEL('DEFile')
